...
- intervention-aware CEA  : **0.731**

Ordering `single-frame <= passive <= intervention-aware` holds: **True** (strictly increasing: True).

With abstention enabled the full method reports CEA(all) = 0.590, CEA(committed) = 0.836 at an abstention rate of 0.295. The gap between those two numbers is the abstention mechanism declining to name a mechanism on cases no allowed action can resolve.
...
- tables: `experiments\phase1_problem_existence\run_20260828_215014_seed42_42bc7de9\tables\method_comparison.csv`, `experiments\phase1_problem_existence\run_20260828_215014_seed42_42bc7de9\tables\method_comparison.md`
