...
- intervention-aware CEA  : **0.722**

Ordering `single-frame <= passive <= intervention-aware` holds: **True** (strictly increasing: True).

With abstention enabled the full method reports CEA(all) = 0.544, CEA(committed) = 0.875 at an abstention rate of 0.378. The gap between those two numbers is the abstention mechanism declining to name a mechanism on cases no allowed action can resolve.
...
- tables: `experiments\phase1_action_noise\run_20260829_013154_seed1_73823b45\tables\method_comparison.csv`, `experiments\phase1_action_noise\run_20260829_013154_seed1_73823b45\tables\method_comparison.md`
