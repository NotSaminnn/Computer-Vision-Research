...
The leave-one-model-out protocol of Table~\ref{tab:learned} is expanded to every held-out checkpoint below, together with the regularisation sweep for the frozen-encoder head.

\begin{table}[!ht]
\caption{\textbf{Learned abstention in full.} \emph{Upper block:} every held-out
checkpoint from Table~\ref{tab:learned}. The policy is trained on the other eleven
